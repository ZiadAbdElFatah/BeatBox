...
public class BeatBox {
    ...
    public void setUpGui() {
        ...
        tempoUp.addActionListener(e -> changeTempo(1.05f));
        buttonBox.add(tempoUp);

        JButton tempoDown = new JButton("Tempo Down");
        tempoDown.addActionListener(e -> changeTempo(0.95f));
        ...
        for (String name : instrumentNames) {
            JLabel instrumentLabel = new JLabel(name);
    ...
    private void changeTempo(float changeInTempo) {
        float currentTempo = sequencer.getTempoFactor();
        sequencer.setTempoFactor(changeInTempo * currentTempo);
    }
